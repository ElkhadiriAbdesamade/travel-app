const Plan = () => {
    return (
        <div className="max-w-[1400px] m-auto py-32 px-4 grid lg:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col justify-center drop-shadow-2xl">
                ...
                <div className="py-8">
                    ...
                    <button className="px-8 py-3 bg-black font-bold text-white rounded-full">Book Your Trip</button>
                </div>
            </div>
        </div>
    );
